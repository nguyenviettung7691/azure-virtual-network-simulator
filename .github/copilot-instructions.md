...
| Exact implementation contracts, data models, algorithms, UI/UX behavior | **ARCHITECTURE.md** | **copilot-instructions.md** |
| High-risk guardrails and do/do-not-change constraints while coding | **copilot-instructions.md** | **ARCHITECTURE.md** |
...
3. **Avoid regressions:** Apply guardrails from **copilot-instructions.md** before finalizing changes.

### Cross-Reference Rule

- Use the Feature Reference table in **ARCHITECTURE.md § 0** to map README-level features to detailed sections.
- If guidance appears to conflict: **ARCHITECTURE.md** defines the implementation contract, while **copilot-instructions.md** defines risk and safety guardrails to apply during implementation.
...
When a task touches AWS or deployment behavior, consult the matching `/docs` file in addition to **README.md**, **ARCHITECTURE.md**, and this file.
